...
3. In the MobileFirst console, under **Applications** → **RememberMeCordova** → **Security** → **Map scope elements to security checks.**, add a mapping from `accessRestricted` to `PinCodeAttempts`.
